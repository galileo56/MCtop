...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/Users/vmateu/GitHub/MCtop/bin/ThrustDistro")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/Users/vmateu/GitHub/MCtop/bin" TYPE EXECUTABLE FILES "/Users/vmateu/GitHub/MCtop/build/ThrustDistro")
  if(EXISTS "$ENV{DESTDIR}/Users/vmateu/GitHub/MCtop/bin/ThrustDistro" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/Users/vmateu/GitHub/MCtop/bin/ThrustDistro")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip" "$ENV{DESTDIR}/Users/vmateu/GitHub/MCtop/bin/ThrustDistro")
    endif()
  endif()
endif()
