...
void vegasthrust P(( int _tp1, double _tp2, double _tp3, double _tp4, double _tp5, const char * _tp6, const char * _tp7, const char * _tp8, const char * _tp9, double _tp10, double _tp11, int _tp12, int _tp13));
...
#endif
{
	...
	vegasthrust(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13);

	res = 1;
L13: L12: L11: L10: L9:	MLReleaseString(mlp, _tp9);
L8:	MLReleaseString(mlp, _tp8);
L7:	MLReleaseString(mlp, _tp7);
L6:	MLReleaseString(mlp, _tp6);
L5: L4: L3: L2: L1: 
...
static const char* evalstrs[] = {
	...
	"ation against Legendre Polynomial plus the delta coefficient for",
	" thrust\"",
	(const char*)0,
...
#endif
{
	...
	if (_res) _res = _definepattern(mlp, (char *)"DistroThrust[mt_, mb_, mW_, Q_, method_, spin_,                  decay_, current_, Cmin_, Cmax_, Nbins_, Nevent_, Niter_]", (char *)"{mt, mb, mW, Q, method, spin, decay, current, Cmin,                  Cmax, Nbins, Nevent, Niter}", 11);
